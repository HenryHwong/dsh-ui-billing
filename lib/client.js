window.__ModuleLoader__.load({
	...
	factory: (require) => {
					...
					children: [
						...
						(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Tooltip, {
							...
							children: (0, react_jsx_runtime.jsx)("button", {
								...
								children: (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconRefreshOutline16, { size: 12 })
							})
						})
					]
				})]
		...
		*/
		function currentSessionProjection(sessions) {
			const list = sessions.list;
			return {
				subscribe: (listener) => list.subscribe(listener),
				face: (key) => {
					const current = list.getSnapshot().current;
					return current === void 0 ? void 0 : sessions.binding(current)?.session.projections.faceOf(key);
				}
			};
		}
		//#endregion
